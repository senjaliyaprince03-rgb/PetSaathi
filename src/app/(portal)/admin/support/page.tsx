  ...
  return (
    <main className="min-h-screen bg-cream/50 py-10">
      <div className="container-shell">
        <p className="eyebrow">audited customer resolution</p>
        <h1 className="section-title mt-5">Support and complaints</h1>
        <p className="mt-5 max-w-3xl text-lg leading-8 text-ink/70">General support and booking complaints follow separate state machines. Safety concerns remain visible to the safety role and every decision records its reason.</p>

...
function Empty({ label }: { label: string }) {
  return <div className="rounded-4xl border border-dashed border-ink/15 bg-paper p-8 text-center text-sm text-ink/80">{label}</div>;
}

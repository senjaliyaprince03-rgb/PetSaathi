      ...
      <div className="max-w-7xl pb-12 space-y-8">
        ...
        <div className="flex flex-col md:flex-row md:items-start justify-between gap-4">
          ...
          <div className="bg-cream/50 p-4 rounded-4xl shadow-lifted border border-ink/5">
            <h3 className="text-sm font-semibold text-ink/80 flex items-center gap-2">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <section className="bg-paper p-6 rounded-4xl shadow-lifted space-y-6 border border-ink/5">
            ...
            {currentHealth ? (
              <div className="space-y-5">
                ...
                <div className="grid grid-cols-2 gap-4 pt-2">
                  <div className="p-3 bg-cream/50 rounded-2xl">
                    <span className="text-xs text-ink/80 uppercase tracking-wider block">Safety</span>
                  ...
                  <div className="p-3 bg-cream/50 rounded-2xl">
                    <span className="text-xs text-ink/80 uppercase tracking-wider block">Supply</span>
                    <div className="text-lg font-semibold flex items-center gap-2 mt-1">
                      {currentHealth.supplyScore}
                    </div>
                  </div>
                  <div className="p-3 bg-cream/50 rounded-2xl">
                    <span className="text-xs text-ink/80 uppercase tracking-wider block">Demand</span>
                    <div className="text-lg font-semibold flex items-center gap-2 mt-1">
                      {currentHealth.demandScore}
                    </div>
                  </div>
                  <div className="p-3 bg-cream/50 rounded-2xl">
                    <span className="text-xs text-ink/80 uppercase tracking-wider block">Operations</span>
                    <div className="text-lg font-semibold flex items-center gap-2 mt-1">
              ...
              <div className="text-center py-8 text-ink/80">No health data available for this period.</div>
            )}
          </section>
          ...
          <section className="bg-paper p-6 rounded-4xl shadow-lifted space-y-6 border border-ink/5">
            ...
            {currentFinance ? (
              <div className="space-y-4">
                ...
                <div className="flex justify-between items-center py-2 border-b border-ink/5">
                  <span className="text-ink/80">CM2 (Contribution Margin 2)</span>
                ...
                <div className="grid grid-cols-2 gap-4 mt-4 pt-2">
                  <div className="p-3 bg-cream/50 rounded-2xl text-center">
                    <span className="text-xs text-ink/80 uppercase tracking-wider block">Blended CAC</span>
                    <div className="text-lg font-semibold mt-1 font-mono text-coral">
                      ₹{(currentFinance.blendedCacPaise / 100).toLocaleString()}
                    </div>
                  </div>
                  <div className="p-3 bg-cream/50 rounded-2xl text-center">
                    <span className="text-xs text-ink/80 uppercase tracking-wider block">Active Customers</span>
              ...
              <div className="text-center py-8 text-ink/80">No financial data available for this period.</div>
            )}
          </section>
        </div>
      </div>

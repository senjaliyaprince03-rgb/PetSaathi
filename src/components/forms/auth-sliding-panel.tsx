...
export function AuthSlidingPanel({ returnTo }: { returnTo?: string }) {
  ...
  return (
    ...
    <div className="auth-card-container relative flex min-h-820 sm:min-h-620 w-full max-w-[900px] overflow-hidden rounded-3xl bg-white shadow-2xl shadow-black/30">
      <div

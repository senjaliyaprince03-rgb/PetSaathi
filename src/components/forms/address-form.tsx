...
export function AddressForm() {
  ...
  return <form onSubmit={form.handleSubmit(submit)} className="glass-panel mx-auto max-w-3xl rounded-5xl p-6 sm:p-10" noValidate>
    ...
    <p className="mt-5 text-xs leading-5 text-ink/80">The exact address is withheld from candidate caregivers and released only after an authorised assignment reaches the correct state.</p>

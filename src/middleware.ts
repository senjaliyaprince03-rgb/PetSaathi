...
export async function middleware(request: NextRequest) {
  ...
  const cspHeader = `
    ...
    connect-src 'self' https://api.razorpay.com https://lumberjack.razorpay.com https://www.google-analytics.com https://region1.google-analytics.com https://www.google.com https://accounts.google.com https://integrate.api.nvidia.com https://connect.facebook.net https://www.clarity.ms https://*.clarity.ms https://*.ingest.us.sentry.io https://*.ingest.sentry.io https://*.sentry.io;

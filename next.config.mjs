    ...
    return [
      {
        ...
        headers: [
          ...
          // Strict CSP — adjust connect-src for your external domains
          {
            ...
            value: [
              "default-src 'self'",
              "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://checkout.razorpay.com https://www.googletagmanager.com https://connect.facebook.net https://www.clarity.ms https://*.clarity.ms https://scripts.clarity.ms https://accounts.google.com",
          ...
          // Legacy XSS protection for older scanners
          {
